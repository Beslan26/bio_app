  ...
  return (
    <div className="p-6 max-w-7xl mx-auto space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 items-start">
        ...
        {/* ПРАВАЯ КОЛОНКА: СПИСОК ВСЕХ ВЫДАННЫХ ЗАДАЧ */}
          ...
          {isLoading ? (
            ...
            <div className="space-y-4 max-h-[600px] overflow-y-auto pr-2">
              {tasks.map((task) => {
                ...
                return (
                  <div key={task.id} className="p-4 rounded-xl border border-slate-100 bg-slate-50/70 flex flex-col gap-2 hover:border-teal-200 transition-colors">
